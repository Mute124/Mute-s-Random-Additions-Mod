...
public class MagmaBlockBlock extends RandomAdditionsModElements.ModElement {
	@ObjectHolder("random_additions:magma_block")
	public static final Block block = null;

	public MagmaBlockBlock(RandomAdditionsModElements instance) {
		super(instance, 18);
	}

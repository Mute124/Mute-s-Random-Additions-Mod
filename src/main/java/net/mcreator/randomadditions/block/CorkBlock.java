...
public class CorkBlock extends RandomAdditionsModElements.ModElement {
	@ObjectHolder("random_additions:cork")
	public static final Block block = null;

	public CorkBlock(RandomAdditionsModElements instance) {
		super(instance, 16);
	}

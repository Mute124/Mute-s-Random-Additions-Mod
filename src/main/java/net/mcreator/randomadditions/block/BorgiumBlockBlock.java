...
public class BorgiumBlockBlock extends RandomAdditionsModElements.ModElement {
	@ObjectHolder("random_additions:borgium_block")
	public static final Block block = null;

	public BorgiumBlockBlock(RandomAdditionsModElements instance) {
		super(instance, 20);
	}

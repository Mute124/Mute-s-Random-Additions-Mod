...
public class BismuthBlockBlock extends RandomAdditionsModElements.ModElement {
	@ObjectHolder("random_additions:bismuth_block")
	public static final Block block = null;

	public BismuthBlockBlock(RandomAdditionsModElements instance) {
		super(instance, 5);
	}

...
public class ConfusionPotionEffect {
	@ObjectHolder("random_additions:confusion")
	...
	public static class EffectCustom extends Effect {
		...
		public void applyAttributesModifiersToEntity(LivingEntity entity, AttributeModifierManager attributeMapIn, int amplifier) {
			...
			ConfusionPotionStartedappliedProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,

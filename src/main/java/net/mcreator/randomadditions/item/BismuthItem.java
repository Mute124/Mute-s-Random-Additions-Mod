...
public class BismuthItem extends RandomAdditionsModElements.ModElement {
	@ObjectHolder("random_additions:bismuth")
	public static final Item block = null;

	public BismuthItem(RandomAdditionsModElements instance) {
		super(instance, 1);
	}

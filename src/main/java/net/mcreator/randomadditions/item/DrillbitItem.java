...
public class DrillbitItem extends RandomAdditionsModElements.ModElement {
	@ObjectHolder("random_additions:drillbit")
	public static final Item block = null;

	public DrillbitItem(RandomAdditionsModElements instance) {
		super(instance, 93);
	}

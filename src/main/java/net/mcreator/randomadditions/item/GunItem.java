...
import net.mcreator.randomadditions.entity.renderer.GunRenderer;
import net.mcreator.randomadditions.RandomAdditionsModElements;

import java.util.Random;

@RandomAdditionsModElements.ModElement.Tag
public class GunItem extends RandomAdditionsModElements.ModElement {
	@ObjectHolder("random_additions:gun")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_gun").setRegistryName("projectile_gun");

	public GunItem(RandomAdditionsModElements instance) {
		super(instance, 23);
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 5.199999999999999, 5);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(BulletsItem.block);
		}

...
public class HeartItem extends RandomAdditionsModElements.ModElement {
	@ObjectHolder("random_additions:heart")
	public static final Item block = null;

	public HeartItem(RandomAdditionsModElements instance) {
		super(instance, 94);
	}
